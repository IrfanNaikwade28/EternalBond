...
//   // ✅ (Optional) If you store context values, also reset them here
//   sessionStorage.clear(); // if you use sessionStorage anywhere
...
{/* 
          <a href="index.html">
            ...
            >
              ...
              <g fill="none" fillRule="evenodd">
                ...
                />
                <use className="fill-warning" xlinkHref="#a"></use>
              </g>
            </svg>
          </a> */}
        </div>
        ...
        style={{ maxWidth: "250px" }} // make search box a little smaller
            ...
            <div className="dropdown d-none d-md-flex">
              ...
              />
                ...
                <span className="account-summary pr-lg-4 d-none d-lg-block">
                  <span className="account-name">{loginUser ? loginUser.Uname : "Guest"}</span>
                  <span className="account-description">{loginUser ? loginUser.urole : "Guest"}</span>
                </span>
              </button>
