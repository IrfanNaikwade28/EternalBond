...
const DeactiveUsers = () => {
  ...
  const fetchUsers = async () => {
    try {
      const res = await axios.get(
        `http://localhost:5000/api/deactive-users?page=${page}&search=${searchText}`
      );
  ...
  const activateUser = async (uid) => {
    const confirmAction = window.confirm("Do you want to activate this user?");
    if (!confirmAction) return;

    try {
      const res = await axios.post(
        "http://localhost:5000/api/deactive-users/update-status",
        { UID: uid }
      );
    ...
    <div className="main-content">
      <div className="page-content">
        <div className="container-fluid">
          ...
          <h3 className="mb-4 text-center">Deactive Users</h3>
                          ...
                          <td>
                            <button
                              ...
                              style={{
                                ...
                                fontWeight: "bold",
                                lineHeight: "20px",
                                backgroundColor: "red", // green background for activation
                              }}
                            >
